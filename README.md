...
##### 📚 Sharing Knowledge: 
I've embarked on the journey of creating the ***"Terraform Zero to Hero"***, ***"Azure Pratices Example"***, ***"Azure DevOps Project"*** series. You can catch this series on LinkedIn and GitHub, where I unravel the magic of these journey step by step.
